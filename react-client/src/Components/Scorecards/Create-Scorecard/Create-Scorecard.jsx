                ...
                >
                    <Row id="row1">
                        ...
                        <Col>
                            ...
                            <Input name="DatePlayed" type="text"  
                            // onChange={(e) => setSearch(e.target.value)}
                            />
                        </Col>
                        <Col>
                        ...
                        <Col>
                            ...
                            <Input name="CourseLength" type="text" 
                            // onChange={(e) => setSearch(e.target.value)}
                            />
                        </Col>
                        <Col>
                            <Label for="DifficultyRating">Difficulty Rating</Label>
                            <Input name="DifficultyRating" type="text" 
                            // onChange={(e) => setSearch(e.target.value)}
                            />
                        </Col>
                    </Row>
                    ...
                    <Row id="row2">
                        ...
                        <Col>
                            ...
                            <Input name="Par18" type="text" 
                            // onChange={(e) => setSearch(e.target.value)}
                            />
                        </Col>
                        <Col>
                            <Label for="Par Total">Par Total</Label>
                            <Input name="Par Total" type="text" 
                            // onChange={(e) => setSearch(e.target.value)}
                            />
                        </Col>
                    </Row>
                    ...
                    <Row id="row3">
                        ...
                        <Col>
                            ...
                            <Input name="Hole18" type="text"  
                            // onChange={(e) => setSearch(e.target.value)}
                            />
                        </Col>
                        <Col>
                            <Label for="Hole Total">Hole Total</Label>
                            <Input name="Hole Total" type="text" 
                            // onChange={(e) => setSearch(e.target.value)}
                            />
                        </Col>
                    </Row>
